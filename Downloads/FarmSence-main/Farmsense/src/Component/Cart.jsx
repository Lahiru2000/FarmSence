...
function Cart() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/api/orders/getCartItems/${userId}`).then((res) => {
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-6">
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Cart for User ID: {userId}</h1>
