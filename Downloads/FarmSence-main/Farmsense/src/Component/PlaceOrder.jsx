      ...
      {products.map((product) => (
        <div key={product.id} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <button
                            ...
                            className={`mt-4 w-full py-2 ${quantities[product.id] > 0 ? "bg-blue-600 hover:bg-blue-700 text-white" : "bg-gray-300 text-gray-500 cursor-not-allowed"} rounded-lg transition-colors duration-300`}
          >
                            Add to Cart
          </button>
        </div>
